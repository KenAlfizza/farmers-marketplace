...
public class RecyclerViewProductListAdapterOld extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerViewProductListAdapterOld(List<String> itemId, List<String> itemList,
